...
class UnalignedCycleGANDataset(BaseDataset):
    """
    ...
    def __init__(self, opt):
        ...
        self.transform_B = get_transform(self.opt, grayscale=(
            output_nc == 1), use_hsv_aug=self.opt.use_hsv_aug, use_gray_aug=self.opt.use_gray_aug, use_gaussian_blur=self.opt.use_gaussian_blur, kernel_size=self.opt.kernel_size, rescale_method=self.opt.s2_rescale_method)
